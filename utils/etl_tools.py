...
# Builtins available to LLM-generated Pandas code executed in execute_code().
# Excludes __import__/exec/eval/open/compile/input so generated code is limited to
# operating on the `pd` DataFrame API rather than reaching the filesystem or interpreter directly.
_UNSAFE_BUILTINS = {"__import__", "exec", "eval", "open", "compile", "input"}
SAFE_EXEC_BUILTINS = {
...
class ETLTools:
    ...
    def execute_code(self,code:str):
        ...
        try:
            exec(code, {"__builtins__": SAFE_EXEC_BUILTINS, "pd": pd})
